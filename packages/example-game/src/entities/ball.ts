...
const createBall = (bindComponents: ComponentBinder, game: Game) => {
    ...
    return bindComponents(constantMoveable, positionable, bounceable, linearCollidable, rectRenderable);
};
